                    ...
                    <div class="px-6 py-4 text-sm text-gray-700">
                        ...
                        <div class="w-full">
                            ...
                            <input type="name" wire:model="name" name="name" id="input-label-with-helper-name"
                                ...
                                placeholder="Express" aria-describedby="hs-input-helper-name" required>
                            @error('name')
                        ...
                        <div class="w-full mt-4">
                            ...
                            <input type="number" wire:model="price" name="price" id="input-label-with-helper-phone"
                                class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="10000" aria-describedby="hs-input-helper-phone" required>
                            @error('price')
                                <span class="text-red-600 text-xs"> {{ $message }} </span>
                            @enderror
                        </div>
                        <div class="w-full mt-4">
                            ...
                            <textarea id="textarea-label" name="description" wire:model="description"
                                ...
                                rows="3" placeholder="3 hari selesai"></textarea>
                            @error('description')
                                <span class="text-red-600 text-xs"> {{ $message }} </span>
                            @enderror
                        </div>
