                    ...
                    <div class="px-6 py-4 text-sm text-gray-700">
                        ...
                        <div class="w-full mt-4">
                            ...
                            <input type="text" wire:model="name" name="name" id="input-label-with-helper-phone"
                                ...
                                placeholder="John Doe" aria-describedby="hs-input-helper-phone" required>
                            @error('name')
                        ...
                        <div class="w-full mt-4">
                            ...
                            <input type="email" wire:model="email" name="email" id="input-label-with-helper-total"
                                ...
                                placeholder="johndoe@mail.com" aria-describedby="hs-input-helper-phone">
                            @error('email')
                                <span class="text-red-600 text-xs"> {{ $message }} </span>
                            @enderror
                        </div>
                        <div class="w-full mt-4">
                            <label for="input-label-with-helper-password"
                                class="block text-sm font-medium mb-2 dark:text-white">Password</label>
                            <input type="password" wire:model="password" name="password"
                                id="input-label-with-helper-password"
                                class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                placeholder="xxxxxxxxxxxxx" aria-describedby="hs-input-helper-password"
